...
func (o *snapshotter) myAttachAndMountBlockDevice(ctx context.Context, snID string, writable string, fsType string, mkfs bool, info snapshots.Info) (retErr error) {
